...
public class Problem {
	...
	@ApiModelProperty(example = "https://consultaspc.com.br/dados-invalidos", position = 10)
	private String type;
	...
	public static class Object {
		...
		@ApiModelProperty(example = "CPF/CNPJ")
		private String name;
		
		@ApiModelProperty(example = "O documento é obrigatório")
		private String userMessage;
